...
export const Input = (props: Omit<React.InputHTMLAttributes<HTMLInputElement>, 'children'>) => (
  <input 
    className="w-full bg-black/50 border border-gray-700 rounded px-2 py-1 text-[10px] text-blue-100 focus:border-blue-500 outline-none transition-colors font-mono"
    {...props}
  />
);

export const Select = (props: React.SelectHTMLAttributes<HTMLSelectElement> & { children?: React.ReactNode }) => (
  <select 
    className="w-full bg-black/50 border border-gray-700 rounded px-1 py-1 text-[10px] text-gray-300 focus:border-blue-500 outline-none appearance-none font-sans cursor-pointer"
    {...props}
  />
);
